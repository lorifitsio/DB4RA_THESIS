...
for n = 1 : snr_length
    ...
    for m = 1 : n_dataset_samples_woj
		...
		y = db4ra_collector((x_array(chirp_sel,:))' + noise,incidentAngle); %calcolo l'uscita delle antenne della chirp che incide con l'angolo definito da incident angle
...
%%
save(".\..\database\ds_rand.mat","y_ds_cell", "doa", "jam", "signals","-v7.3","-nocompression")
