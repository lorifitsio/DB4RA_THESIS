...
function [signals, y_ds_cell, doa, jam] = db4ra_database_sin_jammer (remove_signal,enable_jammer_jitter,t,db4ra_collector, azimuth_start_j, t2j_distance, azimuth_stop_j, f_stop_array,n_chirp_angles, n_jammer_angles_per_chirp, azimuth_angle_vector, elevation_angle, elevation_angle_j, noise_variance, window_length, n_scenarios, sample_length, x_array, n_antennas, fir_coeffs, downsample_array)
    ...
    for m = 1 : n_chirp_angles
		...
		parfor i = 1 : n_jammer_angles_per_chirp
            ...
            y_ds_cell_temp(i,:) = [azimuth_angle f_stop_array(chirp_sel) jammer_freq];
